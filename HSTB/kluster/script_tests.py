    ...
    if repo.name == "kluster":
        ...
        for i in releases:
            for j in i.get_assets():
                print(
                    "{} date: {} download count: {}".format(
                        j.name, j.created_at, j.download_count
                    )
                )
...
datasets = [
    r"C:\collab\dasktest\data_dir\EM122_RonBrown",
    r"C:\collab\dasktest\data_dir\EM710_Rainier",
    r"C:\collab\dasktest\data_dir\EM2040_BHII",
    r"C:\collab\dasktest\data_dir\EM2040_Fairweather_SmallFile",
    r"C:\collab\dasktest\data_dir\EM2040c_NRT2",
    r"C:\collab\dasktest\data_dir\EM2040p_UNH_ASV",
    r"C:\collab\dasktest\data_dir\hassler_acceptance\refsurf",
    r"C:\collab\dasktest\data_dir\Hasslerdual",
    r"C:\collab\dasktest\data_dir\tj_sbet_test\MBES\2904_2019_KongsbergEM2040\2019-216",
    r"C:\collab\dasktest\data_dir\tjacceptance\reference_surface",
    r"C:\collab\dasktest\data_dir\tjmotionlatency\mbes",
    r"C:\collab\dasktest\data_dir\from_Lund\0000_20191009_083350_Narwhal.all",
    r"C:\collab\dasktest\data_dir\from_Lund\0006_20161122_190914_Antares.all",
    r"C:\collab\dasktest\data_dir\from_Lund\0011_20190715_070305_MALASPINA.all",
    r"C:\collab\dasktest\data_dir\from_Lund\0014_20170420_014958_ShipName.all",
    r"C:\collab\dasktest\data_dir\from_Lund\0034_20171114_104317_Astrolabio.all",
    r"C:\collab\dasktest\data_dir\from_Lund\0090_20201202_141721_Narwhal.all",
    r"C:\collab\dasktest\data_dir\from_Lund\0154_20190530_060059_Hesperides.all",
    r"C:\collab\dasktest\data_dir\from_Lund\0389_20170602_094427_Astrolabio.all",
    r"C:\collab\dasktest\data_dir\from_Lund\0681_20201102_191746_TOFINO.all",
    r"C:\collab\dasktest\data_dir\from_Lund\EM2040-0007-t16-20181206-095359.all",
    r"C:\collab\dasktest\data_dir\from_Lund\0063_20210612_092103_MAL_EM2040MKII.kmall",
    r"C:\collab\dasktest\data_dir\from_Lund\0011_20210304_094901_EM2040P.kmall",
    r"C:\collab\dasktest\data_dir\EM2040_HMNZS_wellington_wreck",
    r"C:\collab\dasktest\data_dir\EM712_kmall_fromkongsberg",
]

datasets_w_sbets = [
    r"C:\collab\dasktest\data_dir\ra_mbes\2801_em2040\mbes\2020-035",
...
sbetfils = [
    [
        r"C:\collab\dasktest\data_dir\ra_mbes\2801_em2040\sbet\export_2020_035_2801_A.out",
        None,
        r"C:\collab\dasktest\data_dir\ra_mbes\2801_em2040\sbet\export_2020_035_2801_A.log",
        None,
        None,
        None,
    ],
...
fldernames = [
    ...
    "lund_em2040_kmall",
    "lund_em2040p",
    "EM2040_wellington_wreck",
    "EM712_fromkongsberg_kmall",
]
for cnt, dset in enumerate(datasets):
    fq = perform_all_processing(
        dset,
        outfold=os.path.join(outputdir, fldernames[cnt]),
        coord_system="WGS84",
        vert_ref="waterline",
    )
...
for cnt, dset in enumerate(datasets_w_sbets):
    ...
    generate_new_surface(
        fq, resolution=8.0, output_path=os.path.join(outputdir, fldernames[cnt])
    )

reson_datasets = [
    r"C:\collab\dasktest\data_dir\7125",
    r"C:\collab\dasktest\data_dir\7125_no7030_2devices",
    r"C:\collab\dasktest\data_dir\T51_from_Reson",
    r"C:\collab\dasktest\data_dir\T50_scott_petty",
]
reson_svps = [
    r"C:\collab\dasktest\data_dir\7125\WOA09_20140416_161500.svp",
    r"C:\collab\dasktest\data_dir\7125_no7030_2devices\WOA09_20220617_134138.svp",
    r"C:\collab\dasktest\data_dir\T51_from_Reson\WOA09_20210616_120000.svp",
    [
        r"C:\collab\dasktest\data_dir\T50_scott_petty\WOA09_20170522_180000.svp",
        r"C:\collab\dasktest\data_dir\T50_scott_petty\WOA09_20170523_153000.svp",
    ],
]
...
# concat test
fq_outoforder = perform_all_processing(
    r"C:\collab\dasktest\data_dir\EM2040c_NRT2\0634_20180711_142125.all",
...
assert np.array_equal(
    fq_inorder.multibeam.raw_ping[0].z, fq_outoforder.multibeam.raw_ping[0].z
)
...
st.add_file(
    r"C:\collab\dasktest\data_dir\tj_patch_test\S222_PatchTest_DN077\Processed\SBET\S222_2020_KongsbergEM2040\2020-077\S222_2020_KongsbergEM2040_2020-077_NAD83_SBET.log"
)
st.add_file(
    r"C:\collab\dasktest\data_dir\tj_patch_test\S222_PatchTest_DN077\Processed\SBET\S222_2020_KongsbergEM2040\2020-077\S222_2020_KongsbergEM2040_2020-077_NAD83_SBET.out"
)
...
fq = reload_data(
    r"C:\Pydro21_Dev\NOAA\site-packages\Python38\git_repos\hstb_kluster\test_data\em2040_40111_05_23_2017"
)
polygon = np.array(
    [
        [-122.47798556, 47.78949665],
        [-122.47798556, 47.78895117],
        [-122.47771027, 47.78895117],
...
bs = generate_new_mosaic(
    fq,
    resolution=4.0,
    output_path=r"C:\collab\dasktest\data_dir\T51_from_Reson\mosaictest",
)
...
ad = AllRead(
    r"C:\collab\dasktest\data_dir\EM2040_Fairweather_SmallFile\0009_20170523_181119_FA2806.all"
)
...
ad = X7kRead(
    r"C:\collab\dasktest\data_dir\T51_from_Reson\20210616_102930_0_Odin_T51_Port.s7k"
)
recs = ad.sequential_read_records()
