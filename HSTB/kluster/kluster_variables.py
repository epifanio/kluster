...
super_selected_point_color = (
    1,
    1,
    1,
    1,
)  # color of points in super selection in 3dview
...
default_number_of_chunks = (
    4  # if no dask client is used for parallel processing, we use this many chunks
)
...
vertical_references = [
    ...
    "NOAA MHW",
    "Aviso MLLW",
]  # all vertical reference options
vdatum_vertical_references = [
    "NOAA MLLW",
    "NOAA MHW",
]  # vertical reference options based in vdatum
ellipse_based_vertical_references = [
    "ellipse",
    "NOAA MLLW",
    "NOAA MHW",
]  # vertical reference options based on the ellipsoid
waterline_based_vertical_references = [
    "waterline",
    "Aviso MLLW",
]  # vertical reference options based on waterline
waterleveltides_based_vertical_references = [
    "Aviso MLLW"
]  # vertical reference options with tides, but not base on ellipsoid
vertical_references_explanation = {
    "waterline": "Sound velocity corrected data plus heave minus the waterline value",
...
coordinate_systems = [
    ...
    "NAD83 MA11",
    "WGS84",
]  # horizontal coordinate system options
...
# export
pings_per_las = (
    50000  # LAS export will put this many pings in one file before starting a new file
)
pings_per_csv = (
    15000  # csv export will put this many pings in one file before starting a new file
)
...
# xarray conversion
ping_chunk_size = (
    1000  # chunk size (in pings) of each written chunk of data in the ping records
)
navigation_chunk_size = 50000  # chunk size (in time) of each written chunk of data in the navigation records
attitude_chunk_size = (
    20000  # chunk size (in time) of each written chunk of data in the attitude records
)
...
cast_selection_methods = [
    "nearest_in_time",
    "nearest_in_time_four_hours",
    "nearest_in_distance",
    "nearest_in_distance_four_hours",
]
cast_selection_explanation = {
    "nearest_in_time": f"use the cast that is nearest in time to each {ping_chunk_size} ping chunk of data",
...
processing_log_names = [
    "_conversion_complete",
    "_compute_orientation_complete",
    "_compute_beam_vectors_complete",
    "_sound_velocity_correct_complete",
    "_georeference_soundings_complete",
    "_total_uncertainty_complete",
    "_soundings_last_cleaned",
]
...
default_horizontal_positioning_error = (
    1.000  # default tpu parameter for horizontal positioning
)
default_vertical_positioning_error = (
    0.500  # default tpu parameter for vertical positioning
)
...
variable_format_str = {
    ...
    "altitude": "%1.3f",
    "backscatter": "%1.3f",
    "beampointingangle": "%1.3f",
    "corr_altitude": "%1.3f",
    "corr_heave": "%1.3f",
    "corr_pointing_angle": "%1.6f",
    "counter": "%d",
    "datum_uncertainty": "%1.3f",
    "delay": "%1.6f",
    "fixedgain": "%1.3f",
    "depthoffset": "%1.3f",
    "detectioninfo": "%d",
    ...
    "sbet_longitude": "%1.8f",
    "sbet_altitude": "%1.3f",
    "sbet_north_position_error": "%1.3f",
    "sbet_east_position_error": "%1.3f",
    "sbet_down_position_error": "%1.3f",
    "sbet_roll_error": "%1.3f",
    "sbet_pitch_error": "%1.3f",
    "sbet_heading_error": "%1.3f",
    "soundspeed": "%1.3f",
    "thu": "%1.3f",
    "tiltangle": "%1.3f",
    "pulselength": "%1.3f",
    ...
    "yawpitchstab": "%s",
    "z": "%1.3f",
    "alongtrackvelocity": "%1.3f",
    "down_position_error": "%1.3f",
    "east_position_error": "%1.3f",
    "north_position_error": "%1.3f",
    "pitch_error": "%1.3",
    "roll_error": "%1.3f",
    "heading_error": "%1.3f",
    "heading": "%1.3f",
...
variable_translator = {
    ...
    "nearnormalcorrect": "Near_Normal_Correction",
    "processing_status": "Processing_Status",
    "pulselength": "Pulse_Length",
    "qualityfactor": "Beam_Uncertainty",
    "reflectivity": "Raw_Reflectivity",
    "rel_azimuth": "Relative_Azimuth",
    "sbet_latitude": "SBET_Latitude",
    "sbet_longitude": "SBET_Longitude",
    "sbet_altitude": "SBET_Altitude",
    "sbet_north_position_error": "SBET_North_Position_Error",
    "sbet_east_position_error": "SBET_East_Position_Error",
    "sbet_down_position_error": "SBET_Down_Position_Error",
    "sbet_roll_error": "SBET_Roll_Error",
    "sbet_pitch_error": "SBET_Pitch_Error",
    "sbet_heading_error": "SBET_Heading_Error",
...
variable_reverse_lookup = {
    ...
    "Geohash": "geohash",
    "Near_Normal_Correction": "nearnormalcorrect",
    "SBET_Latitude": "sbet_latitude",
    "SBET_Longitude": "sbet_longitude",
    "SBET_Altitude": "sbet_altitude",
    "SBET_North_Position_Error": "sbet_north_position_error",
...
variable_descriptions = {
    "absorption": "The mean absorption coefficient in dB/km used by the multibeam during TVG correction.  Used during backscatter to remove multibeam applied gain.",
...
int_parameters = [
    "converted_files_at_once",
    "pings_per_las",
    "pings_per_csv",
    "max_profile_length",
    "chunk_size_display",
    "chunk_size_export",
    "max_converted_chunk_size",
]
float_parameters = [
    "default_heave_error",
    "default_roll_sensor_error",
    "default_pitch_sensor_error",
    "default_heading_sensor_error",
    "default_surface_sv_error",
    "default_roll_patch_error",
    "default_separation_model_error",
    "default_waterline_error",
    "default_horizontal_positioning_error",
    "default_vertical_positioning_error",
    "default_beam_opening_angle",
    "mem_restart_threshold",
]
str_parameters = [
    "pass_color",
    "error_color",
...
def alter_variable(varname, varvalue):
    if varname in str_parameters:
        ...
        raise NotImplementedError(
            f"Unable to find matching parameter entry for {varname}, see kluster_variables"
        )
...
if os.path.exists(_kluster_ini):
    ...
    if _sections != ["Kluster"]:
        print(
            f'WARNING: Unable to find "Kluster" section in {_kluster_ini}, skipping overwriting default variables'
        )
    else:
